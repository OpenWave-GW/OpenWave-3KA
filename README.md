...
OpenWave-3KA is an open-source project. It's a simple python program that can get image or raw data from digital storage oscilloscope(GDS-3000A/GDS-73000A/MSO-3000/GDS-2000E/DCS-2000E/IDS-2000E/MSO-2000E/MDO-2000E/MDO-72000E/MDO-2000A/RSMSO-2000E/RSMDO-2000E/RSMDO-2000A/MPO-2000/MPO-72000 series) via USB, ethernet or GPIB(GDS-3000A only) port.  
...
Please unzip [OpenWave-3KA V1.03.zip](/exe/OpenWave-3KA_V1.03.zip) into a folder and find OpenWave-3KA.exe in the folder. OpenWave-3KA.exe can be executed directly without installation.
